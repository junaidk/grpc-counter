...
var file_counter_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x22, 0x1d, 0x0a, 0x05, 0x43, 0x6f, 0x75, 0x6e,
	...
	0x73, 0x67, 0x32, 0x3b, 0x0a, 0x07, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x30, 0x0a,
	0x0a, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x0e, 0x2e, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x0e, 0x2e, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x00, 0x28, 0x01, 0x62,
...
var file_counter_proto_goTypes = []interface{}{
	(*Count)(nil), // 0: counter.Count
	(*Error)(nil), // 1: counter.Error
}
var file_counter_proto_depIdxs = []int32{
	0, // 0: counter.Counter.CountValue:input_type -> counter.Count
	1, // 1: counter.Counter.CountValue:output_type -> counter.Error
...
type CounterClient interface {
	CountValue(ctx context.Context, opts ...grpc.CallOption) (Counter_CountValueClient, error)
}
...
func (c *counterClient) CountValue(ctx context.Context, opts ...grpc.CallOption) (Counter_CountValueClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Counter_serviceDesc.Streams[0], "/counter.Counter/CountValue", opts...)
	if err != nil {
		return nil, err
	}
	x := &counterCountValueClient{stream}
	return x, nil
}

type Counter_CountValueClient interface {
	Send(*Count) error
	CloseAndRecv() (*Error, error)
	grpc.ClientStream
}

type counterCountValueClient struct {
	grpc.ClientStream
}

func (x *counterCountValueClient) Send(m *Count) error {
	return x.ClientStream.SendMsg(m)
}

func (x *counterCountValueClient) CloseAndRecv() (*Error, error) {
...
type CounterServer interface {
	CountValue(Counter_CountValueServer) error
}
...
func (*UnimplementedCounterServer) CountValue(Counter_CountValueServer) error {
	return status.Errorf(codes.Unimplemented, "method CountValue not implemented")
}
...
func _Counter_CountValue_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CounterServer).CountValue(&counterCountValueServer{stream})
}

type Counter_CountValueServer interface {
	SendAndClose(*Error) error
	Recv() (*Count, error)
	grpc.ServerStream
}

type counterCountValueServer struct {
	grpc.ServerStream
}

func (x *counterCountValueServer) SendAndClose(m *Error) error {
	return x.ServerStream.SendMsg(m)
}

func (x *counterCountValueServer) Recv() (*Count, error) {
	m := new(Count)
...
var _Counter_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "CountValue",
			Handler:       _Counter_CountValue_Handler,
			ClientStreams: true,
		},
	},
